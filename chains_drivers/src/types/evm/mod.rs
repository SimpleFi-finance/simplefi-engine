...
// use crate::utils::decoding::logs::evm::evm_logs_decoder;

// use super::{
//     chain::{
//         ConnectionType, Engine, NativeCurrency, SubscribeBlocks,
//         SupportedMethods
//     }, 
//     base::{
//         EntityBlockNumber, EntityContractAddress, RawToValue, EntityTimestamp
//     },
//     evm::{
//         block::Block,
...
//     pub async fn decode_logs<T: EntityBlockNumber + EntityContractAddress + RawToValue + Sync>(
//         &self,
//         logs: Vec<T>,
//         timestamp: i64,
//     ) -> Result<(Vec<Value>, Vec<Value>), Box<dyn std::error::Error>> {
//         let logs_by_address = logs
//             .par_iter()
//             .fold(
//                 || HashMap::new(),
//                 |mut acc, log| {
//                     let log = log.raw_to_value(timestamp);
...
//             let msg = socket
//                 .read_message().expect("Error reading message");
...
//                     Some(block) => {
//                         let decoded = decode_blocks(vec![block.clone()]);
