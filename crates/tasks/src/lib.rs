...
/// ```
/// # async fn t() {
///  use simp_tasks::{TaskSpawner, TokioTaskExecutor};
...
///
/// ```
/// # use simp_tasks::TaskManager;
/// fn t() {
///  use simp_tasks::TaskSpawner;
...
/// Many simp components require to spawn tasks for long-running jobs. For example `discovery`
